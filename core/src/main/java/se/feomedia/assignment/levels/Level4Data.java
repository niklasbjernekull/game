 ...
 */
public class Level4Data implements LevelDataInterface {
    private int[] enemyFormation = {12,4,3,12};
    private String[] enemyType =
            {ImageConstants.ENEMY1, ImageConstants.ENEMY3, ImageConstants.ENEMY3, ImageConstants.ENEMY1};
