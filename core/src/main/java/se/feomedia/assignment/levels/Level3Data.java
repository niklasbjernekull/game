 ...
 */
public class Level3Data implements LevelDataInterface {
    private int[] enemyFormation = {8,6,7,8};
    private String[] enemyType =
            {ImageConstants.ENEMY2, ImageConstants.ENEMY1, ImageConstants.ENEMY2, ImageConstants.ENEMY1};
