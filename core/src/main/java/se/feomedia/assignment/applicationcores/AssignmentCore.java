...
import se.feomedia.assignment.GameApplication;
 ...
 * This handles the assignment game
 *
 * Created by Niklas on 2015-12-03.
 */
public class AssignmentCore implements CoreInterface {
    ...
    /**
     * Constructor initiates variables and loads level
     * @param in_imageHandler
     */
    public AssignmentCore(ImageHandler in_imageHandler) {
    ...
    /**
     * Sets (or resets) game variables
     * And loads level data
     * @param levelNo
     */
    ...
    /**
     * Handles the controls for playing and also the controls when in the Pause and
     * Game over menu.
     */
    ...
    /**
     * Pause game, can be called by pressing P or by the GameApplication class when window
     * is visible
     * @param pauseIt
     */
    @Override
